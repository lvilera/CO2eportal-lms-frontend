// pages/admin/courses/[courseId]/modules/[moduleId]/lessons/[lessonId]/quiz/new.tsx
...
export default function NewQuiz() {
  ...
  const { courseId: queryCourseId, moduleId: queryModuleId } = router.query;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                onChange={onChange}
                placeholder="Please read each question carefully. You have 10 minutes."
                className="w-full px-3 py-2 rounded-lg border border-gray-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 outline-none focus:ring-2 focus:ring-primary/40"
              />
            </div>
