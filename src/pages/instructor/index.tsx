  ...
  return (
    <InstructorLayout>
      <div className="grid md:grid-cols-3 gap-4">
        {/* Active Students in their courses */}
        ...
        {/* Earnings for this instructor */}
        <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white/70 dark:bg-slate-900/60 p-4">
          <div className="flex items-center justify-between">
            <span className="text-sm text-slate-500">Earnings (30d)</span>
            <BarChart3 className="h-4 w-4" />
          </div>
          <div className="mt-2 text-2xl font-semibold">$4,290</div>
        </div>
      </div>
      ...
      <div className="mt-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white/70 dark:bg-slate-900/60 p-6">
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
          Use the left navigation to manage your courses, support your students,
          track performance, and monitor your earnings.
        </p>
      </div>
    </InstructorLayout>
  );
